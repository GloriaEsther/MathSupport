"""
Django settings for MathSupport project.
...
SECRET_KEY = 'django-insecure-1i3w&m14*ofirg8ph_155fi*0r-)$pyd(9)&*%^h6pt%rxu$g9'
...
ROOT_URLCONF = 'MathSupport.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates')],#esto es para que django busque platillas en la carpeta 'templates'
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'MathSupport.wsgi.application'
